...
namespace
{
    ...
    QString mapKey(const QString &key)
    {
        static const QHash<QString, QString> keyMapping = {
            ...
            {"BitTorrent/Session/AutoBanPID", "Preferences/AutoBanPID"},
            {"BitTorrent/Session/AutoBanUA", "Preferences/AutoBanUA"},
            {"BitTorrent/Session/AutoBanPort", "Preferences/AutoBanPort"},
